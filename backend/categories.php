...
if (isset($_SESSION['id']))
{
    ...
    $classQuery = $con->prepare("SELECT * FROM status_page");
    $classQuery->execute();
    $ClassCek=$classQuery-> fetchAll(PDO::FETCH_OBJ);
    $array = 1;
    $query  = $con -> prepare("SELECT * FROM status_page WHERE id = :id");
...
if (isset($_POST['kaydet'])) {
    ...
    try {
       ...
       $sorgula = $con->prepare("UPDATE status_page SET content = ? WHERE id = 1");
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Durum Güncellemesi Sayfası İçeriği</h4>
                        <div class="clearfix"></div>
