...
if (isset($_SESSION['id']))
{
    ...
    $quizQuery = $con->prepare("SELECT * FROM corps");
    $quizQuery->execute();
    $tablocek=$quizQuery-> fetchAll(PDO::FETCH_OBJ);
}
else
{
    echo "403!";
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Kurumlar</h4>
                        <div class="clearfix"></div>
                        <?php
                        if (isset($_GET['ekle'])) {
                          // code...
                          ...
                          try {
                             ...
                             $sorgula = $con->prepare("INSERT INTO corps(name) VALUES(?)");
                            ...
                            //echo $ad,$soyad,$pass_enc, $mail, $tarih, $sinif;
                              ...
                              <div class="alert alert-success alert-dismissible fade in">
                                                                          ...
                                                                          Kurum Başarılı Şekilde Eklendi. Yenileniyor !
                                                                      </div>
                                                              <?php
                                                              header('refresh:2;url=corps.php');
                        ...
                        if(isset($_GET['sil']))
                        {
                          $sorgu=$con->prepare('DELETE FROM corps WHERE id=?');
                            $sonuc=$sorgu->execute([$_GET['sil']]);
                            if($sonuc){
                              echo '  <div class="alert alert-success alert-dismissible fade in">
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                              Kurum Başarılı Şekilde Silindi. Yenileniyor !
                              </div>';
                              header('refresh:2;url=corps.php');
                            }
                            else
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Kurum Ekle</h3>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <h3 class="header-title m-t-0"><small></small></h3>
                                             ...
                                             <form action="corps.php?ekle" method="post">
                ...
                <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Eklenmiş Kurumlar Tablosu</h3>
                                    </div>
                                    <div class="panel-body">
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                              ...
                                              <td> <a type="button" href="corps.php?sil=<?= $cek->id ?>"><button class="btn btn-danger waves-effect waves-light">Konuyu Sil</button></a></td>
